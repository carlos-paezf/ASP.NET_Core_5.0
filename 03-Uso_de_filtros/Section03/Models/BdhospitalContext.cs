...
public partial class BDHospitalContext : DbContext
{
    ...
    public virtual DbSet<TipoUsuarioPaginaBoton> TipoUsuarioPaginaBotones { get; set; }

    public virtual DbSet<Usuario> Usuarios { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-FERRER\\SQLEXPRESS;Initial Catalog=BDHospital;Persist Security Info=True;User ID=SA;Password=P@ssw0rd;Integrated Security=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Boton>(entity =>
        {
            entity.HasKey(e => e.Iidboton).HasName("PK__BOTON__90C2312F68927075");
        ...
        {
            entity.HasKey(e => e.Iidcitamedicamento).HasName("PK__citamedi__E4CCE514844E03D5");
        ...
        {
            entity.HasKey(e => e.Iidcita).HasName("PK_Consulta");
            ...
            entity.HasOne(d => d.IiddoctorasignadoNavigation).WithMany(p => p.Cita)
            ...
            entity.HasOne(d => d.IidpersonaNavigation).WithMany(p => p.Cita)
            ...
            entity.HasOne(d => d.IidusuarioNavigation).WithMany(p => p.Cita)
        ...
        modelBuilder.Entity<Doctor>(entity =>
        {
            ...
            entity.HasOne(d => d.IidespecialidadNavigation).WithMany(p => p.Doctors)
                .HasForeignKey(d => d.Iidespecialidad)
                .HasConstraintName("FK_Doctor_Especialidad");

            entity.HasOne(d => d.IidpersonaNavigation).WithMany(p => p.Doctors)
                .HasForeignKey(d => d.Iidpersona)
                .HasConstraintName("FK__Doctor__IIDPERSO__693CA210");

            entity.HasOne(d => d.IidsedeNavigation).WithMany(p => p.Doctors)
                .HasForeignKey(d => d.Iidsede)
        ...
        {
            entity.HasKey(e => e.Iidespecialidad).HasName("PK_TipoEspecialidad");
        ...
        {
            entity.HasKey(e => e.Iidestado).HasName("PK__ESTACITA__CB0F471FE45B7978");
        ...
        {
            entity.HasKey(e => e.Iidhistorialcita).HasName("PK__Historia__35A9F434FABE77C7");
            ...
            entity.HasOne(d => d.IidcitaNavigation).WithMany(p => p.HistorialCita)
                .HasForeignKey(d => d.Iidcita)
                .HasConstraintName("FK__Historial__IIDCI__07C12930");

            entity.HasOne(d => d.IidestadoNavigation).WithMany(p => p.HistorialCita)
                .HasForeignKey(d => d.Iidestado)
                .HasConstraintName("FK__Historial__IIDES__08B54D69");

            entity.HasOne(d => d.IidusuarioNavigation).WithMany(p => p.HistorialCita)
                .HasForeignKey(d => d.Iidusuario)
        ...
        modelBuilder.Entity<Medicamento>(entity =>
        {
            ...
            entity.HasOne(d => d.IidformafarmaceuticaNavigation).WithMany(p => p.Medicamentos)
        ...
        {
            entity.HasKey(e => e.Iidpaciente).HasName("PK_Pacientes_1");
            ...
            entity.HasOne(d => d.IidtiposangreNavigation).WithMany(p => p.Pacientes)
        ...
        {
            entity.HasKey(e => e.Iidpagina).HasName("PK__Pagina__8E759E4E24D07BF3");
        ...
        {
            entity.HasKey(e => e.Iidpersona).HasName("PK_Paciente");
            ...
            entity.HasOne(d => d.IidusuarioNavigation).WithMany(p => p.Personas)
                .HasForeignKey(d => d.Iidusuario)
        ...
        {
            entity.HasKey(e => e.Iidsede).HasName("PK_Clinica");
        ...
        {
            entity.HasKey(e => e.Iidtipousuariopagina).HasName("PK__TipoUsua__59B815B9209568AC");
            ...
            entity.HasOne(d => d.IidpaginaNavigation).WithMany(p => p.TipoUsuarioPaginas)
                .HasForeignKey(d => d.Iidpagina)
                .HasConstraintName("FK__TipoUsuar__IIDPA__75A278F5");

            entity.HasOne(d => d.IidtipousuarioNavigation).WithMany(p => p.TipoUsuarioPaginas)
        ...
        {
            entity.HasKey(e => e.Iidtipousuariopaginaboton).HasName("PK__TipoUsua__7882D20C06997AB0");
            ...
            entity.HasOne(d => d.IidbotonNavigation).WithMany(p => p.TipoUsuarioPaginaBotons)
                .HasForeignKey(d => d.Iidboton)
                .HasConstraintName("FK__TipoUsuar__IIDBO__797309D9");

            entity.HasOne(d => d.IidtipousuariopaginaNavigation).WithMany(p => p.TipoUsuarioPaginaBotons)
